...
urlpatterns = [
    path('old/type/<int:type_id>/available/', views.AvailableTypedModuleListAPI.as_view(), name='module_list'),
    path('old/type/<int:type_id>/assets/', views.AssetOwnedListAPI.as_view(), name='asset_list'),
    path('old/creator/<int:creator_id>/', views.CreatorModuleListAPI.as_view(), name='creator_list'),
