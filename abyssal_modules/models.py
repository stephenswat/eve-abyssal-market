...
DERIVED_ATTRIBUTES = {
    ...
    100004: {
        ...
        'icon_id': 68,
        'unit_str': '%',
        'value': lambda x: (((1 + x.get_value(64) / 100) * (1 + x.get_value(204) / 100)) - 1) * 100,
        'high_is_good': True
    },
    100005: {
        'types': [49738],
        ...
        'icon_id': 68,
        'unit_str': '%',
        'value': lambda x: (((1 + x.get_value(213) / 100) * (1 + x.get_value(204) / 100)) - 1) * 100,
        'high_is_good': True
    },
}
        ...
        return (
            ...
            .annotate(
                ...
                real_value=Case(
                    ...
                    When(attribute_id__in=[64, 213], then=(F('value') - Value(1)) * Value(100)),
                    When(attribute_id__in=[204], then=((Value(1) / F('value')) - Value(1)) * Value(100)),
                    default=F('value')
                )
            )
        )
